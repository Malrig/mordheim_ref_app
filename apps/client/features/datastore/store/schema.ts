import { SourceStatus } from '@/features/initial_data/data_interfaces/metadata';
...
const metadata_schema = {
  metadata: {
    ...
    source_type: {
      type: 'string',
      default: SourceStatus.Unknown.toString(),
    },
  },
} as const;
...
export type DataStoreType = MergeableStore<
  [typeof TablesSchema, typeof ValuesSchema]
>;
export type DataRelationshipsType = Relationships<
  [typeof TablesSchema, typeof ValuesSchema]
>;
export type DataIndexesType = Indexes<
  [typeof TablesSchema, typeof ValuesSchema]
>;
export type DataQueriesType = Queries<
  [typeof TablesSchema, typeof ValuesSchema]
>;

export function createObjectStoreRelationships(
  store: Store<[typeof TablesSchema, typeof ValuesSchema]>
...
export function createObjectStoreIndexes(
  store: Store<[typeof TablesSchema, typeof ValuesSchema]>
): DataIndexesType {
...
export function createObjectStoreQueries(
  store: Store<[typeof TablesSchema, typeof ValuesSchema]>
): DataQueriesType {
