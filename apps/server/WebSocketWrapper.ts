...
export class WebSocketWrapper extends WebSocket {
  public userClaims?: JWTClaims;
  // The name of the store which this WebSocket is connected to.
  public store?: string;
  ...
  public hasPermission(permission: string): boolean {
    return this.userClaims?.permissions?.includes(permission) ?? false;
  }

  public getRole(): string | undefined {
    return this.userClaims?.user_role;
  }
} 