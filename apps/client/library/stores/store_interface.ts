import { TablesSchema as tbTablesSchema, ValuesSchema as tbValuesSchema, MergeableStore, Indexes, OptionalSchemas, Queries, Relationships, Store } from "tinybase/with-schemas";
import * as UiReact from "tinybase/ui-react/with-schemas";


export interface StoreInterface<StoreSchema extends [tbTablesSchema, tbValuesSchema]> {
