...
const special_rules: SpecialRule[] = [
  ...
  },
  {
    name: 'Trap Blade',
    description:
      'Sword Breaker - Whenever you make a successful parry attempt roll a D6. If you score a 4+, you break the weapon your opponent was using. The weapon is now useless and they must use another one, or if they have no other weapon, resort to unarmed combat.',
  },
  {
    name: 'Pincers',
    description:
      "Veteran's Hand - The Hero may carry no weapons in this arm, but gains an extra attack in close combat with a +1 strength bonus while wearing the Veteran's Hand.. Two-handed weapons are impossible to use with a Veteran's Hand..",
  },
  {
    name: 'Prosthetic',
    description:
  ...
  },
  {
    name: 'Loading Time',
    description:
      'Duck-Footed Pistol - Loading the many barrels of the Duck-Footed Pistol is a difficult task, even for expert gunners. Because of this, it always takes a full turn to reload a Duck-Footed Pistol, regardless of skills the firer might know. He may not fire any non-pistol weapons while reloading.',
  },
  {
    name: 'Unbraced',
    description:
      'Duck-Footed Pistol - You cannot buy a brace of Duck-Footed Pistols, and a single hero can only own one Duck-Footed Pistol at a time. If the firer knows the skill Pistolier, they may fire a Duck-Footed Pistol and a second pistol of any other type at the same time.',
  },
  {
    name: 'Pick Target',
    description:
      'Hochland Long Rifle (or Hunting Rifle) - A model armed with a Hochland long rifle can target any enemy model in sight, not just the closest one..',
  },
  {
    name: 'Prepared Shot',
...
const melee_weapons: Weapon[] = [
  ...
  },
  {
    name: 'Brass Knuckles',
    description:
      'Brass Knuckles are a weapon commonly used by street thugs and robbers who are all too common an infestation in the mighty cities of the Empire. Easily secreted, they are used in pairs and, while cumbersome to use in a straight fight, can cause crippling blows to an opponent with a single, well-landed punch.',
    availability: [{ id: usable_ids.pop()!, rarity: 0, restrictions: [] }],
    price: '20',
    weapon_type: WeaponType.Melee,
    source: '',
  ...
  },
  {
    ...
    description:
      "Grand Masters of Dragon Monk brotherhoods have been known to fight armed with the most curious of items. One such secret of Cathay's weaponsmiths are Iron Fans. Celestial Iron Fans can flick deadly force with the grace of a dance.",
    availability: [{ id: usable_ids.pop()!, rarity: 12, restrictions: [] }],
    price: '125',
    weapon_type: WeaponType.Melee,
    source: '',
  ...
  },
  {
    name: 'Chain Sticks',
    description:
      'Consisting of wooden bars tied together, Chain Sticks are enhanced with iron or steel to gain more striking power. Compared to a Flail it is light, providing the bearer more flexibility in combat.',
  ...
  },
  {
    name: 'Dragon Sword',
    description:
      'Dragon Swords are great-swords that are typically used by Cathayan soldiers, Ronin and occasionally lifted by monks.',
    availability: [
      {
        id: usable_ids.pop()!,
        rarity: 10,
        restrictions: [
          {
            restriction_type: RestrictionType.Warband,
            restriction: 'Battle Monks',
          },
          {
            restriction_type: RestrictionType.Warband,
            restriction: 'Merchant Caravans',
          },
        ],
      },
    ],
  ...
  },
  {
    name: 'Great Axe',
    description:
      'These over-sized Battle Axes can be wielded by only the strongest of warriors.',
    availability: [{ id: usable_ids.pop()!, rarity: 8, restrictions: [] }],
    price: '25',
    weapon_type: WeaponType.Melee,
    source: '',
  ...
  },
  {
    ...
    description:
      'A Kraken-Tooth Sword bites clean through armour, bone and heavy armour. Even the most resistant of victims cannot withstand the sawing attacks of its razor-sharp edge.',
    availability: [{ id: usable_ids.pop()!, rarity: 15, restrictions: [] }],
    price: '165',
    weapon_type: WeaponType.Melee,
    source: '',
    source_type: SourceStatus.Unknown,
  ...
  },
  {
    name: 'Maul',
    description:
      'A massive, double-handed hammer or mace, the Maul is oft a head weighing fifty pounds or more, supported by a big thick oak or metal staff.',
    availability: [
      {
        id: usable_ids.pop()!,
        rarity: 8,
        restrictions: [
          {
            restriction_type: RestrictionType.Warband,
            restriction: "Crazy Grom's Mercs for Hire",
          },
        ],
      },
    ],
  ...
  },
  {
    name: 'Scythe',
    description:
      'Scythes are normally implements used in the fields by farmers. It is rare to see them wielded as weapons of warfare. However, the scythe also carries with it an image of death. It is the symbol of the Grim Reaper, the representation of famine, starvation and disease through the lack of harvested food.Priests of Morr, when they need to, may carry a scythe as a weapon. This is of heavier manufacture, and designed to reap warriors rather than wheat.Because the Scythe is unwieldy, it must be used with two-hands and cannot be used with another weapon, shield or buckler.',
    availability: [{ id: usable_ids.pop()!, rarity: 0, restrictions: [] }],
    price: '10',
    weapon_type: WeaponType.Melee,
    source: '',
  ...
  },
  {
    ...
    description:
      "Silver has a devastating effect on Vampires. It's mere touch can cause excruciating pain and anguish.",
    availability: [
      {
        id: usable_ids.pop()!,
        rarity: 0,
  ...
  },
  {
    name: 'Staffsword',
    description:
      'Believed to be out of the Far East, the Staffsword is little more than an incredibly long blade with an extended hilt in the middle.',
    availability: [
      {
        id: usable_ids.pop()!,
        rarity: 9,
  ...
  },
  {
    name: 'Steel Whip',
    description:
      'Sister of SigmarAnother weapon unique to the Sisterhood is the steel whip, made from barbed steel chains.',
    availability: [
      {
        id: usable_ids.pop()!,
        rarity: 0,
  ...
  },
  {
    name: 'Sword Breaker',
    description:
      "The sword breaker is a specialist weapon wrought by only the most talented sword smiths. Next to the hilt are two prongs concealed within the blade that can be used to trap an opponent's blade, twisting and snapping it with a single, well time movement.",
    availability: [{ id: usable_ids.pop()!, rarity: 8, restrictions: [] }],
    price: '30',
    weapon_type: WeaponType.Melee,
    source: '',
  ...
  },
  {
    name: "Veteran's Hand",
    description:
      'Formed of two or more metal pincers controlled through wires, straps and weights. This expensive prosthetic allows the user to grip and pick up certain objects. These marvels of engineering are made to measure by master craftsmen. Though some are temperamental and rusting, others are exquisite, jewelled and gilded creations sometimes worth more than the person sporting them.',
    availability: [{ id: usable_ids.pop()!, rarity: 12, restrictions: [] }],
    price: '85',
    weapon_type: WeaponType.Melee,
    source: '',
  ...
  },
  {
    name: "Wizard's Staff",
    description:
      'Many Wizards find the use of a staff both practical for their long journeys and defend them when the use of their magical arts will draw suspicion.',
    availability: [
      {
        id: usable_ids.pop()!,
        rarity: 0,
...
const ranged_weapons: Weapon[] = [
  {
    name: 'Blessed Bolts',
    description:
      'Blessed by the Warrior Priest and his Acolytes, the Blessed Bolts may be fired against the enemies of Sigmar.',
    availability: [
      {
        id: usable_ids.pop()!,
        rarity: 0,
  ...
  },
  {
    ...
    description:
      'Huntsmen stalk the unbridled wilds surrounding cities of the Empire skinning foes. A throwing axe procured from one such dark wanderer is a fine quality implement.',
    availability: [{ id: usable_ids.pop()!, rarity: 10, restrictions: [] }],
    price: '30',
    weapon_type: WeaponType.Ranged,
    source: '',
  ...
  },
  {
    name: 'Javelins',
    description:
      'Javelins are short throwing spears specially weighted to travel quite a distance. Although they have a much-reducedrange when compared to an arrow they can cause quite considerable damage when thrown by a person of great strength.',
    availability: [
      {
        id: usable_ids.pop()!,
        rarity: 0,
  ...
  },
  {
    ...
    description:
      "A Magnin knife is a master-crafted version of a throwing knife. Each a fine piece of workmanship, with an eighteen-inch blade honed to a razor's edge. A thing of smooth curves and sharp lines. It is not for show.",
    availability: [{ id: usable_ids.pop()!, rarity: 11, restrictions: [] }],
    price: '45',
    weapon_type: WeaponType.Ranged,
    source: '',
...
const blackpowder_weapons: Weapon[] = [
  {
    name: 'Blunderbuss',
    description:
      'A blunderbuss is a primitive black powder weapon, which fires a hail of lead balls, rusty bolts, bent nails, and other assorted scrap metal. It is a powerful, if erratic, weapon and takes such a long time to load that most warriors discard it after the first shot.',
    availability: [{ id: usable_ids.pop()!, rarity: 9, restrictions: [] }],
    price: '30',
  ...
  },
  {
    ...
    description:
      'Cathayan Candles are explosive pots or sticks, made with black powder and other foreign ingredients. These volatile "Bombas" as peddled by Arabyan dealers',
    availability: [{ id: usable_ids.pop()!, rarity: 9, restrictions: [] }],
    price: '25+1D6',
    weapon_type: WeaponType.Blackpowder,
    source: '',
        ...
        restrictions: [
          {
            ...
            restriction: 'Dwarf Engineers - Dwarf',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    description:
      'A fancy invention that saves a pirate time for reloading, and possibly saving his life in the meantime. The inside is filled from any and all kinds of ammo, from silver rounds for fighting evil spirits to plain rocks from the ground.',
    availability: [{ id: usable_ids.pop()!, rarity: 11, restrictions: [] }],
    price: '60',
    weapon_type: WeaponType.Blackpowder,
    source: '',
  ...
  },
  {
    ...
    description:
      'More of a small musket than a pistol, the weapon has incredible range and accuracy, making it a well sought out weapon (and a status symbol) for any pirate captain.',
    availability: [{ id: usable_ids.pop()!, rarity: 10, restrictions: [] }],
    price: '40/80',
    weapon_type: WeaponType.Blackpowder,
    source: '',
  ...
  },
  {
    name: 'Pistol/brace',
    description:
      'pistol is a small, simple black powder weapon fired by a spring mechanism. Most pistols are expensive, unreliable, and poorly constructed.',
    availability: [{ id: usable_ids.pop()!, rarity: 8, restrictions: [] }],
    price: '15/30',
    weapon_type: WeaponType.Blackpowder,
    source: '',
  ...
  },
  {
    name: 'Pocket Pistol',
    description:
      "A tiny one-barreled weapon, that can easily be concealed in a sleeve, hat, boot, or anywhere else. It's not much use in the middle of a fight, but has been known to get people OUT of them.",
    availability: [{ id: usable_ids.pop()!, rarity: 4, restrictions: [] }],
    price: '5',
    weapon_type: WeaponType.Blackpowder,
    source: '',
    source_type: SourceStatus.Unknown,
